      ...
      render ()
{
    return(
    <Layout>
    <div style={{ background: 'olive',  padding: '30px' }}>

   <div align="center">


    <Segment.Inline>
    <h1>Insurance Verification Page :</h1>

    <Image src='http://clipart-library.com/images/pTqapBpT9.jpg' size='large' />
    </Segment.Inline>
